	...
	return (
		<section id="ons-werk" className="py-20 md:py-32 scroll-mt-20 md:scroll-mt-24">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<p className="text-center text-gray-400 text-sm uppercase tracking-widest mb-3">
					Ons werk
				</p>
				<p className="text-center text-gray-500 text-xs uppercase tracking-widest mb-12 flex items-center justify-center gap-2">
					<span className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-white/5 border border-white/10 text-white/50 text-[10px] font-medium tracking-wider">
					...
					>
						<div className="relative">
							...
							<div
								...
								onKeyDown={(e) => e.key === "Enter" && setActiveVideo(SHOWCASE_VIDEO_ID)}
							>
								<Image
								...
								<div className="absolute top-3 right-3 px-1.5 py-0.5 rounded bg-black/60 backdrop-blur-sm border border-white/10 text-white text-[10px] font-bold tracking-widest">
									4K
								</div>
