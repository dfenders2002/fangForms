        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/fangformagency?igsh=MWU5dXNrZXEydGZsdA%3D%3D&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-accent hover:border-accent/50 transition-colors"
              >
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/1DxQKDUxvV/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-accent hover:border-accent/50 transition-colors"
